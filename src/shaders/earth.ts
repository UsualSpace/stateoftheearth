...
import daymap from "../../public/8k_earth_daymap.jpg"
import normalmap from "../../public/8k_earth_normal_map.jpg"
import specularmap from "../../public/8k_earth_specular_map.jpg"
import nightmap from "../../public/8k_earth_nightmap.jpg"
import cloudmap from "../../public/8k_earth_clouds.jpg"

const loader = new TextureLoader();
const albedo = loader.load(daymap);
const normal = loader.load(normalmap);
const specular = loader.load(specularmap);
const night = loader.load(nightmap);
const clouds = loader.load(cloudmap);
